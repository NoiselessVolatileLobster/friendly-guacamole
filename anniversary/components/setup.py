...
from ..utils import format_aniv_message
...
class SetupModal(discord.ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        try:
            format_aniv_message(self.message_w_year.value, interaction.user, 1)
        ...
        try:
            format_aniv_message(self.message_wo_year.value, interaction.user)
        except KeyError as e:
            await interaction.response.send_message(
                warning(
